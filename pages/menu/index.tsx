...
// Menu data from the original
const menuData = {
  beverages: [
    { name: "Fresh Lime Soda", price: 129, description: "Refreshing lime with sparkling soda" },
    { name: "Ice Tea Lemon/Peach", price: 129, description: "Cool and refreshing iced tea varieties" },
    { name: "Fresh Lime Water", price: 99, description: "Pure fresh lime water" },
    { name: "Softdrinks", price: 30, description: "Assorted carbonated beverages" }
  ],
  mocktails: [
    { name: "Strawberry Passion", price: 159, description: "Sweet strawberry passion fruit blend" },
    { name: "Virgin Mojito", price: 159, description: "Classic mint and lime refresher" },
    { name: "Ginger And Basil Mojito", price: 159, description: "Fresh ginger basil lime wedges with sugar & ice" },
    { name: "Ruthless", price: 159, description: "Litchi cranberry juice, lemon slice mint leaves ice" },
    { name: "Wild Cat Cooler", price: 159, description: "Blueberry & lime juice with light sugar & soda" },
    { name: "Sweet Sunrise", price: 159, description: "Orange cranberry & lemon juice with ice cubes" }
  ],
  boba: [
    { name: "Mango Boba Tea", price: 189, description: "Tropical fusion of creamy milk and luscious mango flavor with popping boba" },
    { name: "Strawberry Boba Tea", price: 189, description: "Refreshing fusion of creamy milk and vibrant strawberry flavor with popping boba" }
  ],
  soups: [
    { name: "Spicy Tomyum Soup", price: { veg: 159, chicken: 169 }, description: "Tangy Thai clear soup with Thai herbs and lemony flavour" },
    { name: "Laksa Ma Soup (Malaysian)", price: { veg: 179, chicken: 189 }, description: "Glorious aromatic curry soup with fried tofu and noodles" },
    { name: "Tom Kha Soup (Thai)", price: { veg: 179, chicken: 189 }, description: "Thai coconut milk broth with zesty galangal and lemongrass" },
    { name: "Hot & Sour Soup", price: { veg: 149, chicken: 159 }, description: "All time favourite medium spicy thick soup with shredded veg/chicken" },
    { name: "Manchow Soup", price: { veg: 149, chicken: 159 }, description: "Medium spicy thick soup with minced veg/chicken and fresh green chillies" }
  ],
  momos: [
    { name: "Classic Momos", price: { veg: 199, chicken: 209, prawns: 309 }, description: "All time favourite classic momos stuffed to satiation" },
    { name: "Shanghai Momos", price: { veg: 199, chicken: 209, prawns: 309 }, description: "Minced veg/chicken/seafood stuffed momos in Shanghai style with spicy sauce" },
    { name: "Crispy Fried Momos", price: { veg: 199, chicken: 209, prawns: 309 }, description: "Crispy fried classic momos served with sweet garlic sauce" },
    { name: "Schezwan Momos", price: { veg: 199, chicken: 209, prawns: 309 }, description: "Classic momos tossed in spicy Schezwan sauce" },
    { name: "Steam / Fried Wonton", price: { veg: 179, chicken: 199, prawns: 309 }, description: "Minced veg/chicken wrapped in wonton, steamed/fried with sweet garlic sauce" }
  ],
  vegStarters: [
    { name: "Mongolian Tofu", price: 279, description: "Crispy tofu stir-fried with savory, sweet, and spicy sauce" },
    { name: "Veg Spring Roll", price: 259, description: "Crispy vegetable spring rolls" },
    { name: "Crispy Corn Garlicky", price: 239, description: "Crispy fried American corn tossed in sweet spicy chilli garlic sauce" },
    { name: "Burmese Chilly Potato", price: 239, description: "Finger cut crispy potatoes wok tossed in medium spicy Burmese sauce" },
    { name: "Honey Chilly Potato", price: 239, description: "Crispy fried finger potato tossed with honey & chilly soya" },
    { name: "Paneer Chilly Dry", price: 289, description: "All time favorite preparation" }
  ],
  nonVegStarters: [
    { name: "Roast Chicken Pepper", price: 279, description: "Roasted chicken with bell pepper tossed in chilly style with crushed black pepper" },
    { name: "Kung Pao Chicken", price: 279, description: "Diced glazed chicken with ginger, light chilly soya, Chinese vinegar, sesame seeds and nuts" },
    { name: "Chicken Burnt Red Chilli Pepper", price: 279, description: "Glazed chicken tossed in burnt chilli flakes and veggies" },
    { name: "Cilantro Chicken", price: 289, description: "Flavorful dish featuring chicken marinated in zesty blend of cilantro, lime juice, garlic, and spices" },
    { name: "Sticky Korean Wings", price: 309, description: "Chicken wings coated in sweet and spicy sauce with gochujang soy sauce, honey, and garlic" }
  ],
  seafoodStarters: [
    { name: "Roasted Thai Chilly Prawns", price: 399, description: "Roasted crispy fried prawns tossed in Thai style" },
    { name: "Singapore Chilly Prawns", price: 399, description: "Fresh prawns cooked in Singaporean style" },
    { name: "Kung Pao Prawns", price: 399, description: "Glazed prawns with ginger, dark light soya, Chinese vinegar, sesame seed and nuts" },
    { name: "Ebi Tempura (6 PCS)", price: 399, description: "Japanese tempura crispy fried prawns with Japanese and ginger infusion/mayo" },
    { name: "Basil Garlic Prawns", price: 399, description: "Fresh prawns prepared in tempting spicy basil sauce" }
  ],
  vegGravy: [
    { name: "Veg Manchurian Gravy", price: 249, description: "Classic vegetable manchurian in rich gravy" },
    { name: "Veg Ball Hot Garlic", price: 249, description: "English veggies with balls of vegetable wok tossed in garlic sauce" },
    { name: "Mushroom Chilly Gravy", price: 269, description: "Light batter fried mushroom with shredded capsicum and onion in special chilly sauce" },
    { name: "Sweet & Sour Veg", price: 249, description: "Dice mix vegetables and chunks of pineapple cooked in sweet sour sauce" },
    { name: "Three Treasure Veg", price: 309, description: "Traditional Mongolian cuisine features straw mushroom, brocolli and pokchoy cooked in medium spicy blackbean sauce" }
  ],
  nonVegGravy: [
    { name: "Chicken Chilly Gravy", price: 289, description: "Classic chicken chilly in rich gravy" },
    { name: "Chicken Hot Garlic/Manchurian", price: 289, description: "Popular chicken preparations in flavorful sauces" },
    { name: "Chicken Madras Curry", price: 409, description: "Sliced chicken prepared in Madras curry paste with curry leaf and coconut milk" },
    { name: "Mongolian Claypot Chicken", price: 299, description: "Diced glazed chicken with ginger, dark light soy, Chinese vinegar and nuts" },
    { name: "Chicken in Black Bean Sauce", price: 309, description: "Classic Chinese preparation with chicken chunks cooked in fresh spicy bean sauce" }
  ],
  seafoodGravy: [
    { name: "Hong Kong Gravy", price: 409, description: "Premium seafood in Hong Kong style gravy" },
    { name: "Chilly Peking", price: 409, description: "Spicy Peking style seafood preparation" },
    { name: "Madras Curry", price: 439, description: "Fresh prawns prepared in Madras curry paste with curry leaf and coconut" },
    { name: "Pomfret (Choice of Sauce)", price: 569, description: "Fresh pomfret with choice of Schezwan or Soya sauce" }
  ],
  curries: [
    { name: "Malaysian Curry", price: { veg: 399, chicken: 419, prawns: 469 }, description: "Traditional Malaysian curry with exotic herbs and nuts, fresh red chilly & coconut cream" },
    { name: "Thai Red/Yellow/Green Curry", price: { veg: 399, chicken: 419, prawns: 469 }, description: "Slow simmered spicy curry with Thai curry paste, fresh sweet coconut, sour tamarind and fresh herbs" },
    { name: "Burmese Khow-suey", price: { veg: 399, chicken: 419, prawns: 469 }, description: "Popular Burmese cuisine, burnt garlic rice/noodles with rich creamy curry" }
  ],
  vegRice: [
    { name: "Veg Fried Rice", price: 239, description: "Classic vegetable fried rice" },
    { name: "Veg Schezwan Fried Rice", price: 259, description: "Spicy Schezwan style fried rice" },
    { name: "Veg Burnt Garlic Rice", price: 269, description: "Aromatic burnt garlic flavored rice" },
    { name: "Veg Thai Chilly Rice", price: 259, description: "Thai wok tossed rice with exotic herbs and Thai green chillies" },
    { name: "Veg Singapore Chilly Rice", price: 269, description: "Singapore style spicy rice preparation" }
  ],
  chickenRice: [
    { name: "Chicken Fried Rice", price: 259, description: "Classic chicken fried rice" },
    { name: "Chicken Schezwan Fried Rice", price: 279, description: "Spicy Schezwan chicken fried rice" },
    { name: "Chicken Burnt Garlic Rice", price: 289, description: "Aromatic chicken rice with burnt garlic" },
    { name: "Thai Chilly Chicken Rice", price: 279, description: "Thai wok tossed rice with chicken, exotic herbs and Thai green chillies" },
    { name: "Indonesian Fried Chicken Rice", price: 289, description: "Indonesian rice tossed in sweet soya with diced chicken" }
  ],
  desserts: [
    { name: "Brownie with Hot Chocolate Sauce", price: 169, description: "Rich chocolate brownie with warm chocolate sauce" },
    { name: "Brownie with Vanilla Ice Cream", price: 169, description: "Decadent brownie served with creamy vanilla ice cream" },
    { name: "Honey Noodle with Ice Cream", price: 169, description: "Sweet honey noodles served with ice cream" }
  ]
};
